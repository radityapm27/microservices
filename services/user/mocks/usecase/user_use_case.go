...
func (_m *UserUseCase) GetUserInfoByID(userID string) (*go_micro_srv_core.UserInfoResponse, error) {
...
func (_m *UserUseCase) ListOfUser() (*go_micro_srv_core.ListUserResponse, error) {
	ret := _m.Called()
